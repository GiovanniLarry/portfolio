...
const Contact = () => {
  ...
  const socialLinks = [
    { name: 'Email', icon: '📧', url: 'mailto:touanilarry@icloud.com' },
    { name: 'Phone', icon: '📱', url: 'tel:+237672467369' },
    { name: 'GitHub', icon: '💻', url: 'https://github.com/GiovanniLarry' },
    { name: 'LinkedIn', icon: '💼', url: 'https://www.linkedin.com/in/larry-giovanni-touani-52717b251?utm_source=share_via&utm_content=profile&utm_medium=member_ios' },
    { name: 'Twitter/X', icon: '🐦', url: 'https://x.com/giovans_fb?s=11' },
  ]
